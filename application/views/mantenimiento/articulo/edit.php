...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Artículos <small>Editar</small></h1>
  </section>
  <!-- Main content -->
      ...
      <div class="box-body">
        ...
        <?php 
          if (!empty(validation_errors())) {
            ...
            $art_id = set_value('art_id');
            $art_codigo = set_value('art_codigo');
            $art_nombre = set_value('art_nombre');
            $art_precio_compra = set_value('art_precio_compra');
            $art_precio_venta = set_value('art_precio_venta');
            $sto_codigo = set_value('sto_codigo');
          }else{
            // Get data from database
            $art_id = $data->art_id;
            $art_codigo = $data->art_codigo;
            $art_nombre = $data->art_nombre;
            $art_precio_compra = $data->art_precio_compra;
            $art_precio_venta = $data->art_precio_venta;
            $sto_codigo = $data->sto_codigo;
          }
        ?>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo form_open(base_url().'Mantenimiento/Articulo/edit/'.$art_id);?>
              <!-- Hidden Inputs -->
              <div class="form-group row col-6">
                <input type="hidden" class="form-control"  id="art_id" name="art_id" value="<?= $art_id; ?>"/>
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-2">
                  <input type="text" class="form-control form-control-md" id="art_codigo" name="art_codigo" value="<?= $art_codigo; ?>" autofocus/>
                </div>        
              </div>
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-4">
                  <input type="text" class="form-control form-control-md" id="art_nombre" name="art_nombre" value="<?= $art_nombre; ?>">
                </div>        
              </div>
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-2">
                  <input type="text" class="form-control form-control-md" id="art_precio_compra" name="art_precio_compra" value="<?= $art_precio_compra; ?>">
                </div>        
              </div>
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-2">
                  <input type="text" class="form-control form-control-md" id="art_precio_venta" name="art_precio_venta" value="<?= $art_precio_venta; ?>">
                </div>        
              </div>
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-2">
                  <input type="text" class="form-control form-control-md" id="sto_codigo" name="sto_codigo" value="<?= $sto_codigo; ?>">
                </div>
              </div>
