...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Permisos <small>Agregar</small></h1>
  </section>
  <!-- Main content -->
      ...
      <div class="box-body">
        ...
        <div class="row"> 
          <div class="col-md-12">
            ...
            <?= form_open(base_url().'Administrador/Permiso/add'); ?>
              <!-- Hidden Inputs -->
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-1">
                  <input type="hidden" id="prm_read" name="prm_read" value="<?= set_value('prm_read');?>">
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-1">
                  <input type="hidden" id="prm_insert" name="prm_insert" value="<?= set_value('prm_insert');?>">
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-1">
                  <input type="hidden" id="prm_update" name="prm_update" value="<?= set_value('prm_update');?>">
              ...
              <div class="form-group row col-6">
                ...
                <div class="col-md-1">
                  <input type="hidden" id="prm_delete" name="prm_delete" value="<?= set_value('prm_delete');?>">
